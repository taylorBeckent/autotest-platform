...
const VariableTable = (props) => {
    ...
    useEffect(() => {
        ...
        if (stepTreeList && stepTreeList.length > 1 && stepTreeList[1]?.defined_variables && stepTreeList[1]?.defined_variables.length > 0) { //. 有默认值
            let newData = transformData(stepTreeList[1]?.defined_variables);
    ...
    const deleteRow = (id) => {
        setDataSource(prev => {
            ...
            updateInterfaceInfo('defined_variables', newList);
            return newList;
        });
    };
