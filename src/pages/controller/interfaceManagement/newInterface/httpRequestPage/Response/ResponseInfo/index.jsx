...
const ResponseInfo = (props) => {
    ...
    useEffect(() => {
        //.body
        if (titleProtocalType == 'HTTP' && responseInfo.data && typeof (responseInfo.data) == 'object') {
            let headerStr = JSON.stringify(responseInfo.data, null, 2);
            setJsonData(headerStr);
        } else if (titleProtocalType == 'TCP' && responseInfo.data && typeof (responseInfo.data) != 'object') {
            setXmlType('2')
            ...
            <Collapse defaultActiveKey="Body">
                <Panel header="Body" key="Body">
                    <div className={styles['monacoEditor']}>
                        {titleProtocalType == 'HTTP' || xmlType == '1' ? <ControlledEditor
                            height="100%"
                            width="100%"
                            language="json"
                            value={jsonData}
                        ...
                        /> : null}
                        {titleProtocalType == 'TCP' && xmlType == '2' ? <TextArea
