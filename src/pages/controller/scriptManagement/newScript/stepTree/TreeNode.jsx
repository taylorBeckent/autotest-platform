...
const TreeNode = React.memo((props) => {
    ...
    const isCommonVariables = (node?.nodeType === 0 && index === 0);
        ...
        >
            ...
            <div className="step-node-preview">
                ...
                >
                    ...
                    {((!node?.isQuote || node.depth == 0) && !isCommonVariables) && (
                        <div className="action-icon">
                            {/* <Button type="link" icon={<LinkOutlined />} size="small" onClick={e => e.stopPropagation()} />
                            <Button type="link" icon={<CopyOutlined />} size="small" onClick={e => e.stopPropagation()} /> */}
