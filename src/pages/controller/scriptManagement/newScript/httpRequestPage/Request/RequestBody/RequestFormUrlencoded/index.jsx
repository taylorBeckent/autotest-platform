...
const RequestFormUrlencoded = (props) => {
    ...
    useEffect(() => {
        if (selectedNode.request_form_urlencoded && selectedNode.request_form_urlencoded.length > 0) {
            setDataSource(transformData(selectedNode.request_form_urlencoded));
        } else {
            setDataSource([]);
            addNewRow();
        }
    ...
    const deleteRow = (id) => {
        setDataSource(prev => {
            ...
            updateTreeList([{ insertKey: 'request_form_urlencoded', insertValue: newList }]);
            return newList;
        });
    };
...
// export default RequestFormUrlencoded;