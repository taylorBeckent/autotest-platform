...
const RequestHeader = (props) => {
    ...
    useEffect(() => {
        if (selectedNode.request_header && selectedNode.request_header.length > 0) { //. 有默认值
            let newData = transformData(selectedNode.request_header);
    ...
    const deleteRow = (id) => {
        setDataSource(prev => {
            ...
            updateTreeList([{ insertKey: 'request_header', insertValue: newList }]);
            return newList;
        });
    };
